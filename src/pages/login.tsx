                ...
                <div className="relative z-30 w-full max-w-md mx-4 ">
                    <div className="glass-effect border border-unicoin-yellow/20 rounded-3xl p-8 shadow-2xl gradient-border my-16">
                        ...
                        <div className="text-center mb-10">
                            <div className="gap-3 mb-6">
                                <div className="flex items-center justify-center">
                                    <img alt='Logo Images' width={100} height={100} src={LogoImage} />
                                </div>
                                <p className="text-unicoin-yellow font-bold text-3xl">UniCoin</p>
                            </div>
                            <h1 className="text-white text-3xl font-semibold mb-2">Selamat Datang Kembali!</h1>
                            <p className="text-white/70">Masuk ke akun UniCoin Anda untuk melanjutkan transaksi digital yang menguntungkan</p>
                        </div>

                        {/* Login Form */}
                        <form className="space-y-6" onSubmit={() => navigator("/home")} autoComplete="off">
                            {/* Email Input */}
                            ...
                            <div className="flex items-center justify-between text-sm">
                                ...
                                <Link to={""} className="text-unicoin-yellow hover:text-unicoin-orange font-medium transition-colors" type="button">
                                    Lupa password?
                                </Link>
                            </div>
                        ...
                        <div className="flex items-center my-8">
                            ...
                            <span className="px-4 text-white/50 text-sm">atau masuk dengan</span>
                            <div className="flex-1 h-px bg-white/20"></div>
                        </div>
                        ...
                        <div className="text-center mt-8 pt-6 border-t border-white/10">
                            ...
                            <Link to={"/register"} className="text-unicoin-yellow hover:text-unicoin-orange font-semibold transition-colors">
                                Daftar sekarang
                            </Link>
                        </div>
                    </div>
